...
```text
โจทย์ให้ผสมสองสีที่รับเข้ามาแล้วแสดงผลออกมา
Input:
รับชื่อสีที่ 1 และ รับชื่อสีที่ 2 ต่อ

Output:
แสดงผลชื่อสีที่ผสมจากสีที่ 1 และ สีที่ 2 หรือแสดงผล Error
```
...
```text
Step 1: รับชื่อสีที่ 1
Step 2: รับชื่อสีที่ 2
Step 3: เช็กว่าสีที่ 1 ตรงกับสีไหน
Step 4: หลังจากเข้าเงื่อนไขสีที่ 1 ก็เช็กสีที่ 2 ต่อ
Step 5: แสดงชื่อสีออกมา หรือ แสดง Error ถ้าชื่อสีที่รับมาไม่ตรงเงื่อนไข
```
...
```text
ทำเหมือนแผนแรก โดยรับชื่อสีที่ 1 และชื่อสีที่ 2 นำไปเช็กว่าสีที่ 1 ตรงกับสีไหนในเงื่อนไข หลังจากเข้าเงื่อนไขสีที่ 1 ก็เช็กสีที่ 2 ต่อ จากนั้นก็แสดงชื่อสีที่ผสมแล้วออกมา หรือ แสดง Error ถ้าชื่อสีที่รับมาไม่ตรงเงื่อนไข
```
...
```text
เพราะมีชื่อสี Pink ที่ไม่มีในเงื่อนไข (Red , Yellow, Blue)
```
