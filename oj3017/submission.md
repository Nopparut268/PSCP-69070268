...
```text
โจทย์ให้คิดว่าบริการร้านอาหาร
Input:
รับจำนวนเงินรวมเฉพาะค่าอาหารและเครื่องดื่มที่สั่ง

Output:
ผลรวมที่ลูกค้าต้องจ่ายหลังจากได้รวมค่าบริการและ VAT 7% และแสดงเป็น float 2 ตำแหน่ง
```
...
```text
Step 1: รับจำนวนเงินรวมเฉพาะค่าอาหารและเครื่องดื่มที่สั่ง
Step 2: คิดค่าบริการ 10% ของราคาอาหาร
Step 3: นำค่า Service ไปเช็กว่า น้อยกว่า 50 หรือ มากกว่า 1000 มั้ย
Step 4: นำค่าบริการไปรวมกับค่าอาหารที่สั่ง
Step 5: เพิ่ม Vat 7% ในราคาที่ต้องจ่ายโดยรวม
Step 6: สั่ง print ราคารวม ค่าบริการ และ Vat แสดงเป็นทศนิยม 2 ตำแหน่ง
```
...
```text
ผมใช้วิธีเดียวกันกับแผนแรก โดยรับจำนวนเงินรวมเฉพาะค่าอาหารและเครื่องดื่มที่สั่ง นำไปคิดค่าบริการ 10% ของราคาอาหาร จากนั้นนำค่า Service ไปเช็กว่า น้อยกว่า 50 หรือ มากกว่า 1000 มั้ย นำค่าบริการที่คิดมาไปรวมกับค่าอาหารที่สั่ง ถัดมาก็เพิ่ม Vat 7% ในราคาที่ต้องจ่ายโดยรวม เมื่อเสร็จก็สั่ง print ราคารวม ค่าบริการ และ Vat แสดงเป็นทศนิยม 2 ตำแหน่ง
```
