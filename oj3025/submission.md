...
```text
step 1: รับค่า เดือน และ วัน
step 2: เช็กว่า เป็น เดือนที่ 3, 6, 9, 12 และ ค่าวัน >= 21 มั้ย
step 3: ถ้าเข้าเงื่อไขข้างบนก็เช็ก เดือน และแสดงผลชื่อฤดู
step 4: ถ้าไม่เข้าเงื่อไขก็ เช็กเดือนแล้ว แสดงผลชื่อฤดู
```
...
```text
ผมใช้วิธี รับค่า เดือน และ วัน ต่อด้วยเช็กว่า เป็น เดือนที่ 3, 6, 9, 12 และ ค่าวัน >= 21 มั้ย ถ้าเข้าเงื่อไขข้างบนก็เช็ก เดือน และแสดงผลชื่อฤดู ถ้าไม่เข้าเงื่อไขก็ เช็กเดือนแล้ว แสดงผลชื่อฤดู
```
