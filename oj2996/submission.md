...
```text
โจทย์ให้สลับตำแหน่งตัวอักษรจากหน้าไปหลัง

Input:
โปรแกรมรับข้อความตัวอักษรยาว 5 ตัวอักษร

Output:
แสดงผลข้อความตัวอักษรภาษาอังกฤษแบบกลับด้านเป็นตัวพิมพ์เล็ก
```
...
```text
step 1: รับตัวอักษร 5 ตัว โดยใช้ .lower() เพื่อทำให้เป็นพิมพ์เล็กทั้งหมด
step 2: สั่งให้ print กลับหลัง โดยกำหนด step คือ -1
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก โดยรับตัวอักษร 5 ตัว โดยใช้ .lower() เพื่อทำให้เป็นพิมพ์เล็กทั้งหมด
และ สั่งให้ print กลับหลัง โดยกำหนด step คือ -1
```
...
```text
เพราะมีทั้งตัวอักษรพิมพ์เล็กและใหม่
```
