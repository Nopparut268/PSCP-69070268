...
```text
โจทย์ให้นับจนนวนตัวอักษร A E I O U

Input:
โปรแกรมรับ String

Output:
จำนวนตัวอักษรที่นับได้
```
...
```text
step 1: รับ input
step 2: นับตัวอักษรแต่ละตัว
step 3: แสดงค่าเฉพาะตัวอักษรที่มีใน input ที่รับมา
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก ที่ใช้ .count() นับตัวอักษรแต่ละตัว แล้วสั่ง print เฉพาะตัวที่มีในค่า input ที่รับมา
```
...
```text
เพราะเป็น String ที่มีตัวที่ต้องการ (A E I O U)
```
...
```text
เพราะมีทั้งตัวอักษรพิมเล็กและใหญ่
```
